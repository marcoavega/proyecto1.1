...
$miconsulta = "SELECT * FROM detalle_entrada_efectivo";
$resultado  = mysqli_query($conexion, $miconsulta);
//consulta para la suma y guardar en varianle result
$sql        = "SELECT SUM(cantidad) as total FROM detalle_entrada_efectivo";
...
<html lang="es-MX">
   ...
   <head>
      ...
      <meta name="description" content="Página de reportes de entrada de efectivo Iglesia de Dios valle verde">
      ...
      <script type="text/javascript" src="../javascript/validar-borrar-entrada.js"></script>
      <title>Página de reportes entrada iglesia de Dios Valle Verde</title>
   </head>
   <body>
      <div class="contenedor-filas-columnas">
         ...
         <div class="columnamapa">
            <div class="mapa">
               <ul>
                  ...
                  <label>>></label>
                  <li><a  class="amapa" href="">Reporte de ingresos</a>
                  </li>
               </ul>
            </div>
         </div>
         ...
         <div class="container">
            <h2 class="h2titulotabla">Reporte datos de ingreso</h2>
            <table class="tabla">
               <tr>
                  <th>ID ingreso</th>
                  <th>Usuario que registro entrada</th>
                  <th>Cantidad</th>
                  <th>Descripción</th>
            ...
            ?>
               ...
               <tr>
                  <td><?php
                     echo ($fila['id_detalle_entrada_efectivo']);
                     ?></td>
                  <td><?php
            ...
            if ($registroconsultaid['id_permisos_usuario_administrador'] == "2") {
            ?>
                  <td><form method='post' action="validar-borrar-entrada.php" onsubmit="return validarBorrar()">  
                     <input id="id_detalle_entrada_efectivo" type='hidden' name='id_detalle_entrada_efectivo' value='<?php echo ($fila['id_detalle_entrada_efectivo']);?>'>
         ...
         <div class="divboton">
            <input class="boton-reporte" type="submit" name="Ver reporte pdf" value="ver reporte pdf" onclick="location.href='reporte/reporte-entrada.php'">
         </div>
        <!--Inicia footer-->
        <footer>
