...
<html lang="es-MX">
   ...
   <head>
      ...
      <meta name="description" content="Pagina de egresos de efectivo de iglesia de dios">
      ...
      <link rel="stylesheet" href="css/estilos-salidas.css">
      <script src="javascript/validar-salida.js"></script>
      <title>Página de egreso de efectivo de administración</title>
   </head>
   <body>
      <div class="contenedor-filas-columnas">
         ...
         <header>
            <div class="caja-header">
               ...
               <div class="titulo-header">
                  <a href="">
                     <h1 class="h1-header">Página de salidas de efectivo</h1>
                  </a>
               </div>
            </div>
         </header>
         ...
         <div class="columnamapa">
            <div class="mapa">
               <ul>
                  ...
                  <label>>></label>
                  <li><a  class="amapa" href="">Salida de efectivo</a>
                  </li>
               </ul>
            </div>
         </div>
         ...
         <!--formulario-->
         <div class="container">
            <h2 class="h2formulario">Captura de datos de salida</h2>
            <form name="validar" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="post" onsubmit="return validarSalida()" class="formulario">
               <label for="comentar" class="labelform">Favor de ingresar los datos de salida:</label>
               <div class="columna1">
               ...
               <div class="columna1">
                  <label for="comentario">Ingrese la descripción del egreso:</label>
               </div>
               <div class="columna2">
