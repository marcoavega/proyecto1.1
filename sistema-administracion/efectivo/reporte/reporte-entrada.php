...
$query     = "SELECT id_detalle_entrada_efectivo, nombre_usuario, cantidad, descripcion, tipo_comprobante, numero_comprobante, fecha_ingreso FROM detalle_entrada_efectivo";
...
while ($row = $resultado->fetch_assoc()) {
    $pdf->Cell(10, 6, utf8_decode($row['id_detalle_entrada_efectivo']), 1, 0, 'C');
    ...
    $pdf->Cell(30, 6, utf8_decode($row['fecha_ingreso']), 1, 1, 'C');
}
