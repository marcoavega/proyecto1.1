...
<html lang="es-MX">
   ...
   <head>
      ...
      <meta name="description" content="Página de ingreso de insumos de Iglesia de Dios valle verde">
      ...
      <script src="../javascript/validar-registro.js"></script>
      <title>Página de ingresos de insumos.</title>
   </head>
   <body>
      ...
      <header>
         <div class="caja-header">
            ...
            <div class="titulo-header">
               <a href="#">
                  <h1 class="h1-header">Página ingresos de insumos</h1>
               </a>
            </div>
         </div>
      </header>
      ...
      <div class="columnamapa">
         <div class="mapa">
            <ul>
               ...
               <label>>></label>
               <li><a  class="amapa" href="#">ingresos de insumos</a>
               </li>
            </ul>
         </div>
      </div>
      ...
      <!--contenedor con el formulario que envía la información tanto a la base de datos con php con método post como a el archivo javascript por medio de id-->
      <div class="container">
         <h2 class="h2formulario">Captura de datos de ingresos</h2>
         <form name="validar" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="post" onsubmit="return validarRegistro()" class="formulario">
            <label for="comentar" class="labelform">Favor de ingresar los datos de ingresos:</label>
            <div class="columna1">
               <label for="fname">Nombre de usuario:</label>
            </div>
            <div class="columna2">
               <input id="nombre_usuario" name="nombre_usuario" type="text" value="<?php
                  echo $_SESSION['nombre_usuario'];
                  ?>" readonly="readonly" class="input">
                  <span class="input-100"><?php echo $usuarioErr;?></span>
            </div>
            <div class="columna1">
               <label for="fname">Ingrese nombre de producto:</label>
            </div>
            <div class="columna2">
               <input id="nombre_articulo" name="nombre_articulo" type="text" placeholder="Ingrese nombre de articulo" class="input">
               <span class="input-100"><?php echo $nombreErr;?></span>
            </div>
            <div class="columna1">
               <label for="comentario">Ingrese la descripción del producto:</label>
            </div>
            <div class="columna2">
               <textarea id="descripcion" name="descripcion" type="text" placeholder="Descripción del artículo" class="input"></textarea>
               <span class="input-100"><?php echo $descripcionErr;?></span>
            </div>
            <div class="columna1">
               <label for="fname">cantidad piezas:</label>
            </div>
            <div class="columna2">
               <input id="cantidad" name="cantidad" type="text" placeholder="Ingrese la cantidad" class="input">
               <span class="input-100"><?php echo $cantidadErr;?></span>
            </div>
            <div class="columna1">
               <label for="fname">Código de barras:</label>
            </div>
            <div class="columna2">
               <input id="codigo" name="codigo" type="text" placeholder="Ingrese el numero" class="input">
               <span class="input-100"><?php echo $codigoErr;?></span>
            </div>
            <div class="columna1">
            ...
            <div class="columna2">
               ...
               <span class="input-100"><?php echo $categoriaErr;?></span>
            </div>
            <div class="columna1">
