...
<html lang="es-MX">
   ...
   <head>
      ...
      <meta name="description" content="Página de registro de salidas Iglesia de Dios valle verde">
      ...
      <link rel="stylesheet" href="css/registro-salida.css">
      <script src="../javascript/validar-entrada-y-salida.js"></script>
      <title>Pagina registro de salidas de insumos</title>
   </head>
   <body>
      <div class="contenedor-filas-columnas">
         ...
         <header>
            <div class="caja-header">
               ...
               <div class="titulo-header">
                  <a href="salida.php">
                     <h1 class="h1-header">Página ingreso de salidas de insumos</h1>
                  </a>
               </div>
            </div>
         </header>
         ...
         <div class="columnamapa">
            <div class="mapa">
               <ul>
                  ...
                  <label>>></label>
                  <li><a  class="amapa" href="salida.php">Salida de insumos</a>
                  </li>
               </ul>
            </div>
         </div>
         ...
         <div class="container">
            <h2 class="h2titulotabla">Registrar salida</h2>
            <table class="tabla" >
               <tr>
         ...
         <!--seguir con formulario-->
           ...
           <div class="formulario"><form method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" onsubmit="return validarEntradaSalida()"> <p class="pseleccione">Seleccione el nombre de articulo:</p>
         ...
         <p class="pseleccione">Ingrese la cantidad a restar:</p>
