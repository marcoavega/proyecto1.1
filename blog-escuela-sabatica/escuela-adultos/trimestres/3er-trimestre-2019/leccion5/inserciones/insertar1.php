...
if ($elcomentario == null || $elcomentario == '') {
    ...
    $miconsulta = "INSERT INTO respuestas_1 (nombre_usuario, comentario, fecha_comentario, ruta_imagen, datos_trimestre, id_usuario_blog_adultos, pregunta) VALUES ('" . $elnombre . "', '" . $elcomentario . "', (adddate(now(),interval -5 hour)), '" . $laimagen . "', '" . $losdatos . "', '" . $elusuario . "', '" . $lapregunta . "')";
