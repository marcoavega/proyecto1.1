...
$miconsulta2   = "INSERT INTO respuestas_2 (nombre_usuario, comentario, fecha_comentario, ruta_imagen, datos_trimestre, id_usuario_blog_adultos, pregunta) VALUES ('" . $elnombre2 . "', '" . $elcomentario2 . "', (adddate(now(),interval -5 hour)), '" . $laimagen2 . "', '" . $losdatos2 . "', '" . $elusuario2 . "', '" . $lapregunta2 . "')";
