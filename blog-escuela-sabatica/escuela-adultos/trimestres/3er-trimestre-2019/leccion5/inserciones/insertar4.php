...
if ($elcomentario4 == null || $elcomentario4 == '') {
    echo '<script>
          ...
          window.location.href="../leccion5.php";
          </script>';
}else{
$miconsulta4   = "INSERT INTO respuestas_4 (nombre_usuario, comentario, fecha_comentario, ruta_imagen, datos_trimestre, id_usuario_blog_adultos, pregunta) VALUES ('" . $elnombre4 . "', '" . $elcomentario4 . "', (adddate(now(),interval -5 hour)), '" . $laimagen4 . "', '" . $losdatos4 . "', '" . $elusuario4 . "', '" . $lapregunta4 . "')";
$resultado4    = mysqli_query($conexion, $miconsulta4);
header("Location: ../leccion5.php");
}
?> 