...
$miconsulta5   = "INSERT INTO respuestas_5 (nombre_usuario, comentario, fecha_comentario, ruta_imagen, datos_trimestre, id_usuario_blog_adultos, pregunta) VALUES ('" . $elnombre5 . "', '" . $elcomentario5 . "', (adddate(now(),interval -5 hour)), '" . $laimagen5 . "', '" . $losdatos5 . "', '" . $elusuario5 . "', '" . $lapregunta5 . "')";
