...
$miconsulta7   = "INSERT INTO respuestas_7 (nombre_usuario, comentario, fecha_comentario, ruta_imagen, datos_trimestre, id_usuario_blog_adultos, pregunta) VALUES ('" . $elnombre7 . "', '" . $elcomentario7 . "', (adddate(now(),interval -5 hour)), '" . $laimagen7 . "', '" . $losdatos7 . "' , '" . $elusuario7 . "', '" . $lapregunta7 . "')";
