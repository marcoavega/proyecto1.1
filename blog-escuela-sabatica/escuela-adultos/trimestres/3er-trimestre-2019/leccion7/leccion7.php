...
<html lang="es-MX">
    ...
    <head>
        ...
        <title>Página de lección <?php echo ($registroleccion['titulo_lecciones_adultos']); ?></title>
    </head>
    <body>
            ...
            <header>
                <div class="caja-header">
                    ...
                    <div class="titulo-header">
                        <a href="">
                            <h1 class="h1-header">LECCIÓN  <?php echo ($registroleccion['titulo_lecciones_adultos']); ?></h1>
                        </a>
                    </div>
                </div>
            </header>
            ...
            <div class="columnamapa">
                <div class="mapa">
                    <ul>
                        ...
                        <label>>></label>
                        <li><a  class="amapa" href="../../../lecciones-3.php">Seleccionar lección</a>
                        </li>
                        <label>>></label>
                        <li><a  class="amapa" href="">Lección actual.</a>
                        </li>
                    </ul>
                </div>
            </div>
            <div class="boton_regresar">
                <a href="../../../lecciones-3.php"><button class="span_pregunta">Regresar</button></a>
            </div>
            ...
            <div class="principal1">
                ...
                <section class="section">
                            ...
                            if ($resultadopregunta1 = mysqli_query($conexion, $respuesta1)) {
                                while ($registropregunta1 = mysqli_fetch_assoc($resultadopregunta1)) {
                                    ...
                                    echo "<div class='h4comentario'>
                                          ...
                                          <div class='div-actualizar-imagen'><p>Comentario: <p class='h3preguntas'> " . $registropregunta1['comentario'] . "</div></p></div>";
                            ...
                            if ($resultadopregunta2 = mysqli_query($conexion, $respuesta2)) {
                                while ($registropregunta2 = mysqli_fetch_assoc($resultadopregunta2)) {
                                    echo "<div class='h4comentario'>
                                                ...
                                                <div class='div-actualizar-imagen'><p>Comentario: <p class='h3preguntas'> " . $registropregunta2['comentario'] . "</div></p></div>";
                                    if ($registroconsultaid['id_permiso_blog'] == "2") {
                                        ?>
                                        <div class="principal1">
                            ...
                            if ($resultadopregunta3 = mysqli_query($conexion, $respuesta3)) {
                                while ($registropregunta3 = mysqli_fetch_assoc($resultadopregunta3)) {
                                    echo "<div class='h4comentario'>
                                                ...
                                                <div class='div-actualizar-imagen'><p>Comentario: <p class='h3preguntas'> " . $registropregunta3['comentario'] . "</div></p></div>";
                                    if ($registroconsultaid['id_permiso_blog'] == "2") {
                                        ?>
                                        <div class="principal1">
                            ...
                            if ($resultadopregunta4 = mysqli_query($conexion, $respuesta4)) {
                                while ($registropregunta4 = mysqli_fetch_assoc($resultadopregunta4)) {
                                    echo "<div class='h4comentario'>
                                                ...
                                                <div class='div-actualizar-imagen'><p>Comentario: <p class='h3preguntas'> " . $registropregunta4['comentario'] . "</div></p></div>";
                                    if ($registroconsultaid['id_permiso_blog'] == "2") {
                                        ?>
                                        <div class="principal1">
                            ...
                            if ($resultadopregunta5 = mysqli_query($conexion, $respuesta5)) {
                                while ($registropregunta5 = mysqli_fetch_assoc($resultadopregunta5)) {
                                    echo "<div class='h4comentario'>
                                                ...
                                                <div class='div-actualizar-imagen'><p>Comentario: <p class='h3preguntas'> " . $registropregunta5['comentario'] . "</div></p></div>";
                                    if ($registroconsultaid['id_permiso_blog'] == "2") {
                                        ?>
                                        <div class="principal1">
                            ...
                            if ($resultadopregunta6 = mysqli_query($conexion, $respuesta6)) {
                                while ($registropregunta6 = mysqli_fetch_assoc($resultadopregunta6)) {
                                    echo "<div class='h4comentario'>
                                                ...
                                                <div class='div-actualizar-imagen'><p>Comentario: <p class='h3preguntas'> " . $registropregunta6['comentario'] . "</div></p></div>";
                                    if ($registroconsultaid['id_permiso_blog'] == "2") {
                                        ?>
                                        <div class="principal1">
                    ...
                    <div class="div_pregunta" id="op7" style="display:none;">
                        ...
                        <form class="respuesta" action="inserciones/insertar7.php" method="post" onsubmit="return validarPregunta7()">
                            ...
                            <div class="row">
                                ...
                                <div class="col-75">
                                    <input class="inputname" id="nombre_usuario7" name="" type="text" value="<?php
                                    echo $_SESSION['nombre_usuario'];
                                    ?>" readonly="readonly">
                                </div>
                            </div>
                    ...
                    <div class="div_pregunta" id="op8" style="display:none;">
                        <div class="sin_pregunta"> Sin pregunta 8. </div>
                    </div>
                    </article>
            </div>
        </div>
