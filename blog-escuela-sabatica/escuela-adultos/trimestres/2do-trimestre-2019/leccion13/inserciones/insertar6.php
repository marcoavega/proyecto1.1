...
if ($elcomentario6 == null || $elcomentario6 == '') {
    echo '<script>
          ...
          window.location.href="../leccion13.php";
          </script>';
}else{
$miconsulta6   = "INSERT INTO respuestas_6 (nombre_usuario, comentario, fecha_comentario, ruta_imagen, datos_trimestre, id_usuario_blog_adultos, pregunta) VALUES ('" . $elnombre6 . "', '" . $elcomentario6 . "', NOW(), '" . $laimagen6 . "', '" . $losdatos6 . "' , '" . $elusuario6 . "', '" . $lapregunta6 . "')";
$resultado6    = mysqli_query($conexion, $miconsulta6);
header("Location: ../leccion13.php");
}
?>