...
if ($elcomentario3 == null || $elcomentario3 == '') {
    echo '<script>
          ...
          window.location.href="../leccion11.php";
          </script>';
}else{
$miconsulta3   = "INSERT INTO respuestas_3 (nombre_usuario, comentario, fecha_comentario, ruta_imagen, datos_trimestre, id_usuario_blog_adultos, pregunta) VALUES ('" . $elnombre3 . "', '" . $elcomentario3 . "', NOW(), '" . $laimagen3 . "', '" . $losdatos3 . "', '" . $elusuario3 . "', '" . $lapregunta3 . "')";
$resultado3    = mysqli_query($conexion, $miconsulta3);
header("Location: ../leccion11.php");
}
?> 