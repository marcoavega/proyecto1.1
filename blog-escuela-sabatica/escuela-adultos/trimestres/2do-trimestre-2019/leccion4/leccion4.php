...
<div class="div_pregunta" id="op1" style="display:none;">
               ...
               <form class="respuesta" action="inserciones/insertar1.php" method="post" onsubmit="return validarPregunta1()">
                  ...
                  <div class="row">
                     <div class="col-75">
                        <input class="pregunta1" id="pregunta1" name="pregunta1" type="text" value="<?php echo $pregunta1;?>" readonly="readonly" >
                     </div>
                  </div>
                  <div class="row">
                     <div class="col-75">
                        <input class="datos_trimestre1" id="datos_trimestre1" name="datos_trimestre1" type="text" value="<?php echo $datosLeccion;?>" readonly="readonly" >
                     </div>
                  </div>
                  <div class="row">
                     <div class="col-25">
...
<div class="div_pregunta" id="op2" style="display:none;">
               ...
               <form class="respuesta" action="inserciones/insertar2.php" method="post" onsubmit="return validarPregunta2()">
                  ...
                  <div class="row">
                     <div class="col-75">
                        <input class="pregunta1" id="pregunta2" name="pregunta2" type="text" value="<?php echo $pregunta2;?>" readonly="readonly" >
                     </div>
                  </div>
                  <div class="row">
                     <div class="col-75">
                        <input class="datos_trimestre1" id="datos_trimestre2" name="datos_trimestre2" type="text" value="<?php echo $datosLeccion;?>" readonly="readonly" >
                     </div>
                  </div>
                  <div class="row">
                     <div class="col-25">
...
<div class="div_pregunta" id="op3" style="display:none;">
               ...
               <form class="respuesta" action="inserciones/insertar3.php" method="post" onsubmit="return validarPregunta3()">
                  ...
                  <div class="row">
                     <div class="col-75">
                        <input class="pregunta1" id="pregunta3" name="pregunta3" type="text" value="<?php echo $pregunta3;?>" readonly="readonly" >
                     </div>
                  </div>
                  <div class="row">
                     <div class="col-75">
                        <input class="datos_trimestre1" id="datos_trimestre3" name="datos_trimestre3" type="text" value="<?php echo $datosLeccion;?>" readonly="readonly" >
                     </div>
                  </div>
                  <div class="row">
                     <div class="col-25">
...
<div class="div_pregunta" id="op4" style="display:none;">
               ...
               <form class="respuesta" action="inserciones/insertar4.php" method="post" onsubmit="return validarPregunta4()">
                  ...
                  <div class="row">
                     <div class="col-75">
                        <input class="pregunta1" id="pregunta4" name="pregunta4" type="text" value="<?php echo $pregunta4;?>" readonly="readonly" >
                     </div>
                  </div>
                  <div class="row">
                     <div class="col-75">
                        <input class="datos_trimestre1" id="datos_trimestre4" name="datos_trimestre4" type="text" value="<?php echo $datosLeccion;?>" readonly="readonly" >
                     </div>
                  </div>
                  <div class="row">
                     <div class="col-25">
...
<div class="div_pregunta" id="op5" style="display:none;">
               ...
               <form class="respuesta" action="inserciones/insertar5.php" method="post" onsubmit="return validarPregunta5()">
                  ...
                  <div class="row">
                     <div class="col-75">
                        <input class="pregunta1" id="pregunta5" name="pregunta5" type="text" value="<?php echo $pregunta5;?>" readonly="readonly" >
                     </div>
                  </div>
                  <div class="row">
                     <div class="col-75">
                        <input class="datos_trimestre1" id="datos_trimestre5" name="datos_trimestre5" type="text" value="<?php echo $datosLeccion;?>" readonly="readonly" >
                     </div>
                  </div>
                  <div class="row">
                     <div class="col-25">
...
<div class="div_pregunta" id="op6" style="display:none;">
               ...
               <form class="respuesta" action="inserciones/insertar6.php" method="post" onsubmit="return validarPregunta6()">
                  ...
                  <div class="row">
                     <div class="col-75">
                        <input class="pregunta1" id="pregunta6" name="pregunta6" type="text" value="<?php echo $pregunta6;?>" >
                     </div>
                  </div>
                  <div class="row">
                     <div class="col-75">
                        <input class="datos_trimestre1" id="datos_trimestre6" name="datos_trimestre6" type="text" value="<?php echo $datosLeccion;?>" >
                     </div>
                  </div>
                  <div class="row">
                     <div class="col-25">
