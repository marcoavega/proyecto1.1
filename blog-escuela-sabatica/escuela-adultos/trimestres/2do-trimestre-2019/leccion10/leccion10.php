...
<html lang="es-MX">
   ...
   <head>
      ...
      <link rel="stylesheet" href="../../css/estilos-leccion1.css">
      <script src="../../../../../javascript/validar-pregunta.js"></script>
      <title>Página de lección 10 de escuela sabática</title>
   </head>
   <body>
         ...
         <header>
            <div class="caja-header">
               ...
               <div class="titulo-header">
                  <a href="">
                     <h1 class="h1-header">Página de lección 10 de escuela sabática</h1>
                  </a>
               </div>
            </div>
         </header>
         ...
         <div class="columnamapa">
            <div class="mapa">
               <ul>
                  ...
                  <label>>></label>
                  <li><a  class="amapa" href="../../../escuelas-trimestres.php">Seleccionar trimestre</a>
                  </li>
                  <label>>></label>
                  <li><a  class="amapa" href="../../../lecciones-2.php">Seleccionar lección</a>
                  </li>
                  <label>>></label>
                  <li><a  class="amapa" href="">Lección 10</a>
                  </li>
               </ul>
            </div>
         </div>
...
<div class="div_preguntas_botones2">
	<a href='javascript:seleccion1(9);'><button class="span_pregunta2">Versículo</button></a>
	<a href='javascript:seleccion1(10);'><button class="span_pregunta2">Lectura bíblica</button></a>
<a href='javascript:seleccion1(11);'><button class="span_pregunta2">Comentario</button></a>
</div>
...
<div class="div_preguntas_botones">
	<a href='javascript:seleccion(1);'><button class="span_pregunta">Pregunta 1</button></a>
	<a href='javascript:seleccion(2);'><button class="span_pregunta">Pregunta 2</button></a>
   <a href='javascript:seleccion(3);'><button class="span_pregunta">Pregunta 3</button></a>
   <a href='javascript:seleccion(4);'><button class="span_pregunta">Pregunta 4</button></a>
   <a href='javascript:seleccion(5);'><button class="span_pregunta">Pregunta 5</button></a>
   <a href='javascript:seleccion(6);'><button class="span_pregunta">Pregunta 6</button></a>
   <a href='javascript:seleccion(7);'><button class="span_pregunta">Pregunta 7</button></a>
<a href='javascript:seleccion(8);'><button class="span_pregunta">Pregunta 8</button></a>
</div>
<div class="div_pregunta" id="op1" style="display:none;">
   ...
   <div class="div_pregunta" id="op2" style="display:none;">
               ...
               <h3 class="h3preguntas"><?php
                  echo ($registropregunta2['pregunta']);
                  ?></h3>
               <h3 class="h3preguntas"><?php
   ...
   <div class="div_pregunta" id="op4" style="display:none;">
               ...
               <h3 class="h3preguntas"><?php
                  echo ($registropregunta4['pregunta']);
                  ?></h3>
               <h3 class="h3preguntas"><?php
   ...
   <div class="div_pregunta" id="op6" style="display:none;">
               ...
               <h3 class="h3preguntas"><?php
                  echo ($registropregunta6['pregunta']);
                  ?></h3>
               <h3 class="h3preguntas"><?php
   ...
   <div class="div_pregunta" id="op7" style="display:none;">
         <!--Pregunta 7-->
<h2 class="h2preguntas">Pregunta 7</h2>
               <h3 class="h3preguntas"><?php
                  echo ($registropregunta7['pregunta']);
                  ?></h3>
               <h3 class="h3preguntas"><?php
                  echo ($registropregunta7['nombre_citas']);
                  ?></h3>
               <h3 class="h3preguntas"><?php
                  echo ($registropregunta7['citas']);
                  ?></h3>
               <div class="comentarios">
                  <?php
                     $respuesta7 = "SELECT * FROM respuestas_7  WHERE pregunta='" . $pregunta7 . "' AND datos_trimestre='" . $datosLeccion . "' ORDER BY fecha_comentario desc";
                     if ($resultadopregunta7 = mysqli_query($conexion, $respuesta7)) {
                         while ($registropregunta7 = mysqli_fetch_assoc($resultadopregunta7)) {
                             echo "<div class='h4comentario'>
                                                <div class='div-actualizar-imagen'><img class='actualizar-imagen' src='/imagenes/imagenes2/" . $registropregunta7['ruta_imagen'] . "' alt='' /></div>
                                                <div class='div-actualizar-imagen'><p>usuario que realiza comentario: <p class='h4comentario-p'> " . $registropregunta7['nombre_usuario'] . "</p></p></div>
                                                <div class='div-actualizar-imagen'><p>fecha en que se realizó el comentario: <p class='h4comentario-p'> " . $registropregunta7['fecha_comentario'] . "</p></div>
                                                <div class='div-actualizar-imagen'><p>Comentario: <p class='h4comentario-p'> " . $registropregunta7['comentario'] . "</div></p></div>";
                             if ($registroconsultaid['id_permiso_blog'] == "2") {
                     ?>
                  <div class="principal1">
                     <form method='post' action='eliminar/eliminar7.php'>
                        <input type='hidden' name='comentario' value='<?php
                           echo ($registropregunta7['comentario']);
                           ?>'>
                        <input type='submit' value='Eliminar' class='boton_entrar'>
                     </form>
                  </div>
               ...
               <form class="respuesta" action="inserciones/insertar7.php" method="post" onsubmit="return validarPregunta7()">
                  <label class="label_contestar" for="comentar1">Favor de contestar en esta área: </label>
                  <div class="row">
                     <div class="col-25">
                        <label class="fname" for="fname">Nombre de usuario:</label>
                     ...
                     <div class="col-75">
                        <input class="inputname" id="nombre_usuario7" name="nombre_usuario7" type="text" value="<?php
                           echo $_SESSION['nombre_usuario'];
                           ?>" readonly="readonly">
                     </div>
                  </div>
                  ...
                  <div class="row">
                     <div class="col-75">
                        <input class="imagen1" id="imagen7" name="imagen7" type="text" value="<?php
                           echo $ruta_img;
                           ?>" readonly="readonly" >
                     </div>
                  </div>
                  <div class="row">
                     <div class="col-75">
                        <input class="id_usuario1" id="id_usuario7" name="id_usuario7" type="text" value="<?php
                           echo $_SESSION['id_usuario_blog_adultos'];
                           ?>" readonly="readonly" >
                     </div>
                  </div>
                  <div class="row">
                     <div class="col-75">
                        <input class="pregunta1" id="pregunta7" name="pregunta7" type="text" value="<?php
                           echo $pregunta7;
                           ?>" readonly="readonly" >
                     </div>
                  </div>
                  <div class="row">
                     <div class="col-75">
                        <input class="datos_trimestre1" id="datos_trimestre7" name="datos_trimestre7" type="text" value="<?php
                           echo $datosLeccion;
                           ?>" readonly="readonly" >
                     </div>
                  </div>
                  <div class="row">
                     ...
                     <div class="col-75">
                        <textarea class="textarea" id="contenido_comentario7" name="contenido_comentario7" placeholder="Comentario o respuesta." ></textarea>
                     </div>
                  </div>
                  <div class="row">
                     <input class="boton_entrar" type="submit" value="Contestar 7ma pregunta">
                  </div>
               </form>
            </article>
		 </div>
...
<!--Pregunta 8-->
<h2 class="h2preguntas">Pregunta 8</h2>
               <h3 class="h3preguntas"><?php
                  echo ($registropregunta8['pregunta']);
                  ?></h3>
               <h3 class="h3preguntas"><?php
                  echo ($registropregunta8['nombre_citas']);
                  ?></h3>
               <h3 class="h3preguntas"><?php
                  echo ($registropregunta8['citas']);
                  ?></h3>
               <div class="comentarios">
                  <?php
                     $respuesta8 = "SELECT * FROM respuestas_8  WHERE pregunta='" . $pregunta8 . "' AND datos_trimestre='" . $datosLeccion . "' ORDER BY fecha_comentario desc";
                     if ($resultadopregunta8 = mysqli_query($conexion, $respuesta8)) {
                         while ($registropregunta8 = mysqli_fetch_assoc($resultadopregunta8)) {
                             echo "<div class='h4comentario'>
                                                <div class='div-actualizar-imagen'><img class='actualizar-imagen' src='/imagenes/imagenes2/" . $registropregunta8['ruta_imagen'] . "' alt='' /></div>
                                                <div class='div-actualizar-imagen'><p>usuario que realiza comentario: <p class='h4comentario-p'> " . $registropregunta8['nombre_usuario'] . "</p></p></div>
                                                <div class='div-actualizar-imagen'><p>fecha en que se realizó el comentario: <p class='h4comentario-p'> " . $registropregunta8['fecha_comentario'] . "</p></div>
                                                <div class='div-actualizar-imagen'><p>Comentario: <p class='h4comentario-p'> " . $registropregunta8['comentario'] . "</div></p></div>";
                             if ($registroconsultaid['id_permiso_blog'] == "2") {
                     ?>
                  <div class="principal1">
                     <form method='post' action='eliminar/eliminar8.php'>
                        <input type='hidden' name='comentario' value='<?php
                           echo ($registropregunta8['comentario']);
                           ?>'>
                        <input type='submit' value='Eliminar' class='boton_entrar'>
                     </form>
                  </div>
               ...
               <form class="respuesta" action="inserciones/insertar8.php" method="post" onsubmit="return validarPregunta8()">
                  <label class="label_contestar" for="comentar1">Favor de contestar en esta área: </label>
                  <div class="row">
                     <div class="col-25">
                        <label class="fname" for="fname">Nombre de usuario:</label>
                     ...
                     <div class="col-75">
                        <input class="inputname" id="nombre_usuario8" name="nombre_usuario8" type="text" value="<?php
                           echo $_SESSION['nombre_usuario'];
                           ?>" readonly="readonly">
                     </div>
                  </div>
                  ...
                  <div class="row">
                     <div class="col-75">
                        <input class="imagen1" id="imagen8" name="imagen8" type="text" value="<?php
                           echo $ruta_img;
                           ?>" readonly="readonly" >
                     </div>
                  </div>
                  <div class="row">
                     <div class="col-75">
                        <input class="id_usuario1" id="id_usuario8" name="id_usuario8" type="text" value="<?php
                           echo $_SESSION['id_usuario_blog_adultos'];
                           ?>" readonly="readonly" >
                     </div>
                  </div>
                  <div class="row">
                     <div class="col-75">
                        <input class="pregunta1" id="pregunta8" name="pregunta8" type="text" value="<?php
                           echo $pregunta8;
                           ?>" readonly="readonly" >
                     </div>
                  </div>
                  <div class="row">
                     <div class="col-75">
                        <input class="datos_trimestre1" id="datos_trimestre8" name="datos_trimestre8" type="text" value="<?php
                           echo $datosLeccion;
                           ?>" readonly="readonly" >
                     </div>
                  </div>
                  <div class="row">
                     ...
                     <div class="col-75">
                        <textarea class="textarea" id="contenido_comentario8" name="contenido_comentario8" placeholder="Comentario o respuesta." ></textarea>
                     </div>
                  </div>
                  <div class="row">
                     <input class="boton_entrar" type="submit" value="Contestar 8ma pregunta">
                  </div>
               </form>
            </article>
		 </div>
