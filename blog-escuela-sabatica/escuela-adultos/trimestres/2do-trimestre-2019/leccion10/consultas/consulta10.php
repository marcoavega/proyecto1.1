...
$consulta_leccion = "SELECT * FROM lecciones_adultos WHERE titulo_lecciones_adultos='LECCIÓN 10 VERDAD O MENTIRA' AND datos_trimestre='2do trimestre de 2019, abril, mayo, junio de 2019'";
...
$pregunta8                           = "SELECT * FROM preguntas_8 WHERE titulo_lecciones_adultos='$usarleccion'";
$resultadopregunta8                  = mysqli_query($conexion, $pregunta8);
$registropregunta8                 = mysqli_fetch_assoc($resultadopregunta8);
...
$pregunta8 = $registropregunta8['pregunta'];
