...
<html lang="es-MX">
   ...
   <head>
      ...
      <meta name="description" content="Pagina de lección 1 de escuela sabatica por trimestre de blog de escuela sabatica de adultos">
      ...
      <title>Página de lección 3 de escuela sabática</title>
   </head>
   <body>
         ...
         <header>
            <div class="caja-header">
               ...
               <div class="titulo-header">
                  <a href="">
                     <h1 class="h1-header">Página de lección 3 de escuela sabática</h1>
                  </a>
               </div>
            </div>
         </header>
         ...
         <div class="columnamapa">
            <div class="mapa">
               <ul>
                  ...
                  <label>>></label>
                  <li><a  class="amapa" href="">Lección 3</a>
                  </li>
               </ul>
            </div>
         </div>
...
<div class="div_pregunta" id="op1" style="display:none;">
   ...
   <div class="div_pregunta" id="op2" style="display:none;">
               ...
               <form class="respuesta" action="inserciones/insertar2.php" method="post" onsubmit="return validarPregunta2()">
                  ...
                  <div class="row">
                     <div class="col-75">
                        <input class="imagen1" class="imagen1" id="imagen2" name="imagen2" type="text" value="<?php
                           echo $ruta_img;
                           ?>" readonly="readonly" >
                     </div>
                  </div>
                  <div class="row">
                     <div class="col-75">
                        <input class="id_usuario1" class="id_usuario1" id="id_usuario2" name="id_usuario2" type="text" value="<?php
                           echo $_SESSION['id_usuario_blog_adultos'];
                           ?>" readonly="readonly" >
                     </div>
                  </div>
                  <div class="row">
                     <div class="col-75">
                        <input class="pregunta1" class="pregunta1" id="pregunta2" name="pregunta2" type="text" value="<?php
                           echo $pregunta2;
                           ?>" readonly="readonly" >
                     </div>
                  </div>
                  <div class="row">
                     <div class="col-75">
                        <input class="datos_trimestre1" class="datos_trimestre1" id="datos_trimestre2" name="datos_trimestre2" type="text" value="<?php
                           echo $datosLeccion;
                           ?>" readonly="readonly" >
                     </div>
                  </div>
