...
<html lang="es-MX">
   ...
   <head>
      ...
      <title>Página de lección 6 de escuela sabática</title>
   </head>
   <body>
         ...
         <header>
            <div class="caja-header">
               ...
               <div class="titulo-header">
                  <a href="">
                     <h1 class="h1-header">Página de lección 6 de escuela sabática</h1>
                  </a>
               </div>
            </div>
         </header>
         ...
         <div class="columnamapa">
            <div class="mapa">
               <ul>
                  ...
                  <label>>></label>
                  <li><a  class="amapa" href="../../../lecciones.php">Seleccionar lección</a>
                  </li>
                  <label>>></label>
                  <li><a  class="amapa" href="">Lección 6</a>
                  </li>
               </ul>
            </div>
         </div>
         <div class="boton_regresar">
         <a href="../../../lecciones.php"><button class="span_pregunta">Regresar</button></a>
         </div>
...
<div class="div_pregunta" id="op1" style="display:none;">
               ...
               <form class="respuesta" action="inserciones/insertar1.php" method="post" onsubmit="return validarPregunta1()">
                  ...
                  <div class="row">
                     <div class="col-75">
                        <input id="imagen1" name="imagen1" type="text" value="<?php
                           echo $ruta_img;
                  ...
                  <div class="row">
                     <div class="col-75">
                        <input id="id_usuario1" name="id_usuario1" type="text" value="<?php
                  ...
                  <div class="row">
                     <div class="col-75">
                        <input id="pregunta1" name="pregunta1" type="text" value="<?php
                           echo $pregunta1;
                  ...
                  <div class="row">
                     <div class="col-75">
                        <input id="datos_trimestre1" name="datos_trimestre1" type="text" value="<?php
                           echo $datosLeccion;
                           ?>" readonly="readonly" style="visibility:hidden">
                     </div>
                  </div>
   ...
   <div class="div_pregunta" id="op2" style="display:none;">
               ...
               <form class="respuesta" action="inserciones/insertar2.php" method="post" onsubmit="return validarPregunta2()">
                  ...
                  <div class="row">
                     <div class="col-75">
                        <input id="imagen2" name="imagen2" type="text" value="<?php
                           echo $ruta_img;
                           ?>" readonly="readonly"  style="display:none">
                     </div>
                  </div>
                  <div class="row">
                     <div class="col-75">
                        <input id="id_usuario2" name="id_usuario2" type="text" value="<?php
                           echo $_SESSION['id_usuario_blog_adultos'];
                           ?>" readonly="readonly" style="visibility:hidden">
                     </div>
                  </div>
                  <div class="row">
                     <div class="col-75">
                        <input id="pregunta2" name="pregunta2" type="text" value="<?php
                           echo $pregunta2;
                           ?>" readonly="readonly" style="visibility:hidden">
                     </div>
                  </div>
                  <div class="row">
                     <div class="col-75">
                        <input id="datos_trimestre2" name="datos_trimestre2" type="text" value="<?php
                           echo $datosLeccion;
                           ?>" readonly="readonly" style="visibility:hidden">
                     </div>
                  </div>
   ...
   <div class="div_pregunta" id="op3" style="display:none;">
               ...
               <form class="respuesta" action="inserciones/insertar3.php" method="post" onsubmit="return validarPregunta3()">
                  ...
                  <div class="row">
                     <div class="col-75">
                        <input id="imagen3" name="imagen3" type="text" value="<?php
                           echo $ruta_img;
                           ?>" readonly="readonly"  style="display:none">
                     </div>
                  </div>
                  <div class="row">
                     <div class="col-75">
                        <input id="id_usuario3" name="id_usuario3" type="text" value="<?php
                           echo $_SESSION['id_usuario_blog_adultos'];
                           ?>" readonly="readonly" style="visibility:hidden">
                     </div>
                  </div>
                  <div class="row">
                     <div class="col-75">
                        <input id="pregunta3" name="pregunta3" type="text" value="<?php
                           echo $pregunta3;
                           ?>" readonly="readonly" style="visibility:hidden">
                     </div>
                  </div>
                  <div class="row">
                     <div class="col-75">
                        <input id="datos_trimestre3" name="datos_trimestre3" type="text" value="<?php
                           echo $datosLeccion;
                           ?>" readonly="readonly" style="visibility:hidden">
                     </div>
                  </div>
   ...
   <div class="div_pregunta" id="op4" style="display:none;">
               ...
               <form class="respuesta" action="inserciones/insertar4.php" method="post" onsubmit="return validarPregunta4()">
                  ...
                  <div class="row">
                     <div class="col-75">
                        <input id="imagen4" name="imagen4" type="text" value="<?php
                           echo $ruta_img;
                           ?>" readonly="readonly"  style="display:none">
                     </div>
                  </div>
                  <div class="row">
                     <div class="col-75">
                        <input id="id_usuario4" name="id_usuario4" type="text" value="<?php
                           echo $_SESSION['id_usuario_blog_adultos'];
                           ?>" readonly="readonly" style="visibility:hidden">
                     </div>
                  </div>
                  <div class="row">
                     <div class="col-75">
                        <input id="pregunta4" name="pregunta4" type="text" value="<?php
                           echo $pregunta4;
                           ?>" readonly="readonly" style="visibility:hidden">
                     </div>
                  </div>
                  <div class="row">
                     <div class="col-75">
                        <input id="datos_trimestre4" name="datos_trimestre4" type="text" value="<?php
                           echo $datosLeccion;
                           ?>" readonly="readonly" style="visibility:hidden">
                     </div>
                  </div>
   ...
   <div class="div_pregunta" id="op5" style="display:none;">
               ...
               <form class="respuesta" action="inserciones/insertar5.php" method="post" onsubmit="return validarPregunta5()">
                  ...
                  <div class="row">
                     <div class="col-75">
                        <input id="imagen5" name="imagen5" type="text" value="<?php
                           echo $ruta_img;
                           ?>" readonly="readonly"  style="display:none">
                     </div>
                  </div>
                  <div class="row">
                     <div class="col-75">
                        <input id="id_usuario5" name="id_usuario5" type="text" value="<?php
                           echo $_SESSION['id_usuario_blog_adultos'];
                           ?>" readonly="readonly" style="visibility:hidden">
                     </div>
                  </div>
                  <div class="row">
                     <div class="col-75">
                        <input id="pregunta5" name="pregunta5" type="text" value="<?php
                           echo $pregunta5;
                           ?>" readonly="readonly" style="visibility:hidden">
                     </div>
                  </div>
                  <div class="row">
                     <div class="col-75">
                        <input id="datos_trimestre5" name="datos_trimestre5" type="text" value="<?php
                           echo $datosLeccion;
                           ?>" readonly="readonly" style="visibility:hidden">
                     </div>
                  </div>
   ...
   <div class="div_pregunta" id="op6" style="display:none;">
               ...
               <form class="respuesta" action="inserciones/insertar6.php" method="post" onsubmit="return validarPregunta6()">
                  ...
                  <div class="row">
                     <div class="col-75">
                        <input id="imagen6" name="imagen6" type="text" value="<?php
                           echo $ruta_img;
                           ?>" readonly="readonly"  style="display:none">
                     </div>
                  </div>
                  <div class="row">
                     <div class="col-75">
                        <input id="id_usuario6" name="id_usuario6" type="text" value="<?php
                           echo $_SESSION['id_usuario_blog_adultos'];
                           ?>" readonly="readonly" style="visibility:hidden">
                     </div>
                  </div>
                  <div class="row">
                     <div class="col-75">
                        <input id="pregunta6" name="pregunta6" type="text" value="<?php
                           echo $pregunta6;
                           ?>" readonly="readonly" style="visibility:hidden">
                     </div>
                  </div>
                  <div class="row">
                     <div class="col-75">
                        <input id="datos_trimestre6" name="datos_trimestre6" type="text" value="<?php
                           echo $datosLeccion;
                           ?>" readonly="readonly" style="visibility:hidden">
                     </div>
                  </div>
...
<h2 class="h2preguntas">Pregunta 7</h2>
               ...
               <form class="respuesta" action="inserciones/insertar7.php" method="post" onsubmit="return validarPregunta7()">
                  ...
                  <div class="row">
                     <div class="col-75">
                        <input id="imagen7" name="imagen7" type="text" value="<?php
                           echo $ruta_img;
                           ?>" readonly="readonly"  style="display:none">
                     </div>
                  </div>
                  <div class="row">
                     <div class="col-75">
                        <input id="id_usuario7" name="id_usuario7" type="text" value="<?php
                           echo $_SESSION['id_usuario_blog_adultos'];
                           ?>" readonly="readonly" style="visibility:hidden">
                     </div>
                  </div>
                  <div class="row">
                     <div class="col-75">
                        <input id="pregunta7" name="pregunta7" type="text" value="<?php
                           echo $pregunta7;
                           ?>" readonly="readonly" style="visibility:hidden">
                     </div>
                  </div>
                  <div class="row">
                     <div class="col-75">
                        <input id="datos_trimestre7" name="datos_trimestre7" type="text" value="<?php
                           echo $datosLeccion;
                           ?>" readonly="readonly" style="visibility:hidden">
                     </div>
                  </div>
