...
include "consultas/consulta12.php";
...
<html lang="es-MX">
   ...
   <head>
      ...
      <title>Página de lección 11 de escuela sabática</title>
   </head>
   <body>
         ...
         <header>
            <div class="caja-header">
               ...
               <div class="titulo-header">
                  <a href="">
                     <h1 class="h1-header">Página de lección 11 de escuela sabática</h1>
                  </a>
               </div>
            </div>
         </header>
         ...
         <div class="columnamapa">
            <div class="mapa">
               <ul>
                  ...
                  <label>>></label>
                  <li><a  class="amapa" href="">Lección 12</a>
                  </li>
               </ul>
            </div>
         </div>
