...
$leccion                             = "SELECT * FROM lecciones_adultos WHERE titulo_lecciones_adultos='LECCIÓN 11. APARTADO DESDE ANTES DE LA FUNDACION DEL MUNDO'";
$resultadoleccion                    = mysqli_query($conexion, $leccion);
$registroleccion                     = mysqli_fetch_assoc($resultadoleccion);
$fecha                               = "SELECT * FROM fecha_leccion WHERE titulo_lecciones_adultos='LECCIÓN 11. APARTADO DESDE ANTES DE LA FUNDACION DEL MUNDO'";
$resultadofecha                      = mysqli_query($conexion, $fecha);
$registrofecha                       = mysqli_fetch_assoc($resultadofecha);
$versiculo                           = "SELECT * FROM versiculo_memorizar_adultos WHERE titulo_lecciones_adultos='LECCIÓN 11. APARTADO DESDE ANTES DE LA FUNDACION DEL MUNDO'";
$resultadoversiculo                  = mysqli_query($conexion, $versiculo);
$registroversiculo                   = mysqli_fetch_assoc($resultadoversiculo);
$lectura                             = "SELECT * FROM lectura_biblica_adultos WHERE titulo_lecciones_adultos='LECCIÓN 11. APARTADO DESDE ANTES DE LA FUNDACION DEL MUNDO'";
$resultadolectura                    = mysqli_query($conexion, $lectura);
$registrolectura                     = mysqli_fetch_assoc($resultadolectura);
$objetivo                            = "SELECT * FROM objetivo_adultos WHERE titulo_lecciones_adultos='LECCIÓN 11. APARTADO DESDE ANTES DE LA FUNDACION DEL MUNDO'";
$resultadoobjetivo                   = mysqli_query($conexion, $objetivo);
$registroobjetivo                    = mysqli_fetch_assoc($resultadoobjetivo);
$comentario                          = "SELECT * FROM comentario_adultos WHERE titulo_lecciones_adultos='LECCIÓN 11. APARTADO DESDE ANTES DE LA FUNDACION DEL MUNDO'";
$resultadocomentario                 = mysqli_query($conexion, $comentario);
$registrocomentario                  = mysqli_fetch_assoc($resultadocomentario);
$pregunta1                           = "SELECT * FROM preguntas_1 WHERE titulo_lecciones_adultos='LECCIÓN 11. APARTADO DESDE ANTES DE LA FUNDACION DEL MUNDO'";
$resultadopregunta1                  = mysqli_query($conexion, $pregunta1);
$registropregunta1                   = mysqli_fetch_assoc($resultadopregunta1);
$pregunta2                           = "SELECT * FROM preguntas_2 WHERE titulo_lecciones_adultos='LECCIÓN 11. APARTADO DESDE ANTES DE LA FUNDACION DEL MUNDO'";
$resultadopregunta2                  = mysqli_query($conexion, $pregunta2);
$registropregunta2                   = mysqli_fetch_assoc($resultadopregunta2);
$pregunta3                           = "SELECT * FROM preguntas_3 WHERE titulo_lecciones_adultos='LECCIÓN 11. APARTADO DESDE ANTES DE LA FUNDACION DEL MUNDO'";
$resultadopregunta3                  = mysqli_query($conexion, $pregunta3);
$registropregunta3                   = mysqli_fetch_assoc($resultadopregunta3);
$pregunta4                           = "SELECT * FROM preguntas_4 WHERE titulo_lecciones_adultos='LECCIÓN 11. APARTADO DESDE ANTES DE LA FUNDACION DEL MUNDO'";
$resultadopregunta4                  = mysqli_query($conexion, $pregunta4);
$registropregunta4                   = mysqli_fetch_assoc($resultadopregunta4);
$pregunta5                           = "SELECT * FROM preguntas_5 WHERE titulo_lecciones_adultos='LECCIÓN 11. APARTADO DESDE ANTES DE LA FUNDACION DEL MUNDO'";
$resultadopregunta5                  = mysqli_query($conexion, $pregunta5);
$registropregunta5                   = mysqli_fetch_assoc($resultadopregunta5);
$pregunta6                           = "SELECT * FROM preguntas_6 WHERE titulo_lecciones_adultos='LECCIÓN 11. APARTADO DESDE ANTES DE LA FUNDACION DEL MUNDO'";
$resultadopregunta6                  = mysqli_query($conexion, $pregunta6);
$registropregunta6                   = mysqli_fetch_assoc($resultadopregunta6);
$pregunta7                           = "SELECT * FROM preguntas_7 WHERE titulo_lecciones_adultos='LECCIÓN 11. APARTADO DESDE ANTES DE LA FUNDACION DEL MUNDO'";
