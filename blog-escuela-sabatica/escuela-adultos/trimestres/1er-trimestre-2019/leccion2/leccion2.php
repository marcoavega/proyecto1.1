...
<html lang="es-MX">
   ...
   <head>
      ...
      <title>Página de lección 2 de escuela sabática</title>
   </head>
   <body>
         ...
         <header>
            <div class="caja-header">
               ...
               <div class="titulo-header">
                  <a href="">
                     <h1 class="h1-header">Página de lección 2 de escuela sabática</h1>
                  </a>
               </div>
            </div>
         </header>
         ...
         <div class="columnamapa">
            <div class="mapa">
               <ul>
                  ...
                  <label>>></label>
                  <li><a  class="amapa" href="">Lección 2</a>
                  </li>
               </ul>
            </div>
         </div>
...
<div class="div_pregunta" id="op1" style="display:none;">
               ...
               <div class="comentarios">
                  ...
                  <div class="principal1">
                     <form method='post' action='eliminar/eliminar1.php'>
                        <input type='hidden' name='comentario' value='<?php echo ($registropregunta1['comentario']);?>'>
               ...
               <form class="respuesta" action="inserciones/insertar1.php" method="post" onsubmit="return validarPregunta1()">
                  ...
                  <div class="row">
                     <div class="col-75">
                        <input id="pregunta1" name="pregunta1" type="text" value="<?php echo $pregunta1;?>" readonly="readonly" style="visibility:hidden">
                     </div>
                  </div>
                  <div class="row">
                     <div class="col-75">
                        <input id="datos_trimestre1" name="datos_trimestre1" type="text" value="<?php echo $datosLeccion;?>" readonly="readonly" style="visibility:hidden">
                     </div>
                  </div>
                  <div class="row">
                     <div class="col-25">
   ...
   <div class="div_pregunta" id="op2" style="display:none;">
               ...
               <div class="comentarios">
                  ...
                  <div class="principal1">
                     <form method='post' action='eliminar/eliminar2.php'>
                        <input type='hidden' name='comentario' value='<?php echo ($registropregunta2['comentario']);?>'>
                        <input type='submit' value='Eliminar' class='boton_entrar'>
                     </form>
                  </div>
                  <?php
               ...
               <form class="respuesta" action="inserciones/insertar2.php" method="post" onsubmit="return validarPregunta2()">
                  ...
                  <div class="row">
                     <div class="col-75">
                        <input id="pregunta2" name="pregunta2" type="text" value="<?php echo $pregunta2;?>" readonly="readonly" style="visibility:hidden">
                     </div>
                  </div>
                  <div class="row">
                     <div class="col-75">
                        <input id="datos_trimestre2" name="datos_trimestre2" type="text" value="<?php echo $datosLeccion;?>" readonly="readonly" style="visibility:hidden">
                     </div>
                  </div>
                  <div class="row">
                     <div class="col-25">
   ...
   <div class="div_pregunta" id="op3" style="display:none;">
               ...
               <div class="comentarios">
                  ...
                  <div class="principal1">
                     <form method='post' action='eliminar/eliminar3.php'>
                        <input type='hidden' name='comentario' value='<?php echo ($registropregunta3['comentario']);?>'>
                        <input type='submit' value='Eliminar' class='boton_entrar'>
                     </form>
                  </div>
                  <?php
               ...
               <form class="respuesta" action="inserciones/insertar3.php" method="post" onsubmit="return validarPregunta3()">
                  ...
                  <div class="row">
                     <div class="col-75">
                        <input id="pregunta3" name="pregunta3" type="text" value="<?php echo $pregunta3;?>" readonly="readonly" style="visibility:hidden">
                     </div>
                  </div>
                  <div class="row">
                     <div class="col-75">
                        <input id="datos_trimestre3" name="datos_trimestre3" type="text" value="<?php echo $datosLeccion;?>" readonly="readonly" style="visibility:hidden">
                     </div>
                  </div>
                  <div class="row">
                     <div class="col-25">
   ...
   <div class="div_pregunta" id="op4" style="display:none;">
               ...
               <div class="comentarios">
                  ...
                  <div class="principal1">
                     <form method='post' action='eliminar/eliminar4.php'>
                        <input type='hidden' name='comentario' value='<?php echo ($registropregunta4['comentario']);?>'>
                        <input type='submit' value='Eliminar' class='boton_entrar'>
                     </form>
                  </div>
                  <?php
               ...
               <form class="respuesta" action="inserciones/insertar4.php" method="post" onsubmit="return validarPregunta4()">
                  ...
                  <div class="row">
                     <div class="col-75">
                        <input id="pregunta4" name="pregunta4" type="text" value="<?php echo $pregunta4;?>" readonly="readonly" style="visibility:hidden">
                     </div>
                  </div>
                  <div class="row">
                     <div class="col-75">
                        <input id="datos_trimestre4" name="datos_trimestre4" type="text" value="<?php echo $datosLeccion;?>" readonly="readonly" style="visibility:hidden">
                     </div>
                  </div>
                  <div class="row">
                     <div class="col-25">
   ...
   <div class="div_pregunta" id="op5" style="display:none;">
               ...
               <div class="comentarios">
                  ...
                  <div class="principal1">
                     <form method='post' action='eliminar/eliminar5.php'>
                        <input type='hidden' name='comentario' value='<?php echo ($registropregunta5['comentario']);?>'>
                        <input type='submit' value='Eliminar' class='boton_entrar'>
                     </form>
                  </div>
                  <?php
               ...
               <form class="respuesta" action="inserciones/insertar5.php" method="post" onsubmit="return validarPregunta5()">
                  ...
                  <div class="row">
                     <div class="col-75">
                        <input id="pregunta5" name="pregunta5" type="text" value="<?php echo $pregunta5;?>" readonly="readonly" style="visibility:hidden">
                     </div>
                  </div>
                  <div class="row">
                     <div class="col-75">
                        <input id="datos_trimestre5" name="datos_trimestre5" type="text" value="<?php echo $datosLeccion;?>" readonly="readonly" style="visibility:hidden">
                     </div>
                  </div>
                  <div class="row">
                     <div class="col-25">
   ...
   <div class="div_pregunta" id="op6" style="display:none;">
               ...
               <div class="comentarios">
                  ...
                  <div class="principal1">
                     <form method='post' action='eliminar/eliminar6.php'>
                        <input type='hidden' name='comentario' value='<?php echo ($registropregunta6['comentario']);?>'>
                        <input type='submit' value='Eliminar' class='boton_entrar'>
                     </form>
                  </div>
                  <?php
               ...
               <form class="respuesta" action="inserciones/insertar6.php" method="post" onsubmit="return validarPregunta6()">
                  ...
                  <div class="row">
                     <div class="col-75">
                        <input id="pregunta6" name="pregunta6" type="text" value="<?php echo $pregunta6;?>" readonly="readonly" style="visibility:hidden">
                     </div>
                  </div>
                  <div class="row">
                     <div class="col-75">
                        <input id="datos_trimestre6" name="datos_trimestre6" type="text" value="<?php echo $datosLeccion;?>" readonly="readonly" style="visibility:hidden">
                     </div>
                  </div>
                  <div class="row">
                     <div class="col-25">
