...
<html lang="es-MX">
   ...
   <head>
      ...
      <title>Página de lección 7 de escuela sabática</title>
   </head>
   <body>
   <div class="contenedor-filas-columnas"><!--primerdiv-->
       <!--Inicia header-->
			 <header>
         <div class="caja-header">
            ...
            <div class="titulo-header">
               <a href="">
                  <h1 class="h1-header">Página de lección 7 de escuela sabática</h1>
               </a>
            </div>
         </div>
      </header>
            ...
            <div class="columnamapa">
               <div class="mapa">
                  <ul>
                     ...
                     <label>>></label>
                     <li><a  class="amapa" href="">Lección 7</a>
                     </li>
                  </ul>
               </div>
            </div>
       ...
       <h2 class="h2_titulo_principal"><?php echo ($registroleccion['titulo_lecciones_adultos']); ?></h2>
       <h3 class="h3fecha">Fecha:<?php echo ($registrofecha['fecha']); ?></h3>
	   <div class="objetivo">
